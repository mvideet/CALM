#!/bin/bash
#SBATCH -J calm_eurosat
#SBATCH -o /data/sls/u/urop/mvideet/sparse_audio/slurm/out/calm_eurosat_%j.out
#SBATCH -e /data/sls/u/urop/mvideet/sparse_audio/slurm/err/calm_eurosat_%j.err
#SBATCH --qos=regular
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --requeue

#!/bin/bash
#SBATCH -J calm_eurosat_phi4
#SBATCH -o /data/sls/u/urop/mvideet/sparse_audio/slurm/out/calm_eurosat_phi4_%j.out
#SBATCH -e /data/sls/u/urop/mvideet/sparse_audio/slurm/err/calm_eurosat_phi4_%j.err
#SBATCH --qos=regular
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --requeue
